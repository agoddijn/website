...
\name{Alexander}{Goddijn}
%\address{4317 w 13th Ave, Vancouver, Canada}
\mobile{(+31) 6 3411 9727}

\email{alex.goddijn@gmail.com}
\homepage{www.agoddijn.com}
\github{agoddijn}
\linkedin{agoddijn}
%\skype{skypeid}
...
\position{Physics {\enskip\cdotp\enskip} Computer Science {\enskip\cdotp\enskip} Engineering} % Your expertise/fields
%\quote{``Make the change that you want to see in the world."} % A quote or statement

\makecvfooter{\today}{Alexander Goddijn~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
