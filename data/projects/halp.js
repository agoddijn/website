...
module.exports =  {
    ...
    sections: [
        {
            header: "Introduction",
            descriptionAbove: "For this project we were asked to design and build an autonomous machine capable of completing a specific challenge in teams of four. The challenge was to save stuffed animals from a 'burning building' in a certain amount of time. To save a pet, the robot had to put the pet in the starting zone through whatever means necessary within 2 minutes. After 1 minute a 'wall of fire' would appear, preventing the robot from returning from the last zone.",
