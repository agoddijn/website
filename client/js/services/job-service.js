    ...
    positions: [
      {
        ...
        github: "https://github.com/agoddijn/cluster-algorithm",
        additional: [
          {
            type: "code",
            content: "\
...
public Point2D findCentre(Hub hub) {\n\
  ...
  var axiomzen = {
    ...
    positions: [
      {
        name: "Software Engineer",
        descriptionAbove: "Worked on backend and frontend web design for <a href='https://routific.com/' target='_blank'>Routific</a>",
        descriptionBelow: "",
        additional: [
          {
            type: "website",
