app.service('AboutData', function(){
  ...
  return {s: shortDescription, l: longDescription, hs: educationHS, uni: educationUNI, home: home, langs: languages};
});